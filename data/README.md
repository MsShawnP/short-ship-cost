...
| Table | Description |
|---|---|
| `orders` | 66,101 orders with retailer, channel, dates |
| `order_lines_original` | 191,371 lines as submitted |
| `order_lines_shipped` | 191,371 lines as shipped (after triage) |
